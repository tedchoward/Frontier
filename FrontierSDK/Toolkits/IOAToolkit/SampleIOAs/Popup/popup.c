...
static boolean clickpopup (hdlobject listhead, hdlobject h, Point pt, boolean flshiftkey, boolean fl2click) {
	...
	CheckItem (hmenu, (**hdata).checkeditem, true);
...
void setuppopup (tyconfigrecord *);


void setuppopup (tyconfigrecord *config) {
