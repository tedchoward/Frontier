...
typedef void (*setupcallback) (tyconfigrecord *);
...
static void callsetuproutine (setupcallback callback, tyconfigrecord *config) {
	
	IOAclearbytes (config, longsizeof (tyconfigrecord));
...
void name_of_IOA_setup_routine (tyconfigrecord *); /*forward declaration*/
...
static pascal ComponentResult getconfigcommand (tyconfigrecord *stackedconfig) {
	
	BlockMove (&config, stackedconfig, longsizeof (tyconfigrecord));
...
static pascal ComponentResult debugobjectcommand (hdlobject h, Str255 errorstring) {
	...
	enum {
		getconfigcommandProcInfo = kPascalStackBased
			| RESULT_SIZE(SIZE_CODE(sizeof(ComponentResult)))
			| STACK_ROUTINE_PARAMETER(1, SIZE_CODE(sizeof(tyconfigrecord *)))
		};
	...
	// create the routine descriptors
	...
	*/
	...
	void setupbutton (tyconfigrecord *); /*prototype*/
		
	void setupcolorpopup (tyconfigrecord *); /*prototype*/
		
	void setupcheckbox (tyconfigrecord *); /*prototype*/
		
	void setupedittext (tyconfigrecord *); /*prototype*/
		
	void setupframe (tyconfigrecord *); /*prototype*/
		
	void setupicon (tyconfigrecord *); /*prototype*/
		
	void setuppicture (tyconfigrecord *); /*prototype*/
		
	void setuppopup (tyconfigrecord *); /*prototype*/
		
	void setupradio (tyconfigrecord *); /*prototype*/
		
	void setuprect (tyconfigrecord *); /*prototype*/
		
	void setupstatic (tyconfigrecord *); /*prototype*/
		
	void setupscrollbar (tyconfigrecord *); /*prototype*/
	
	#define ioacount 13
		
	static tyconfigrecord configarray [ioacount];
	...
	static boolean IOAregister (short ixarray, OSType subtype, ComponentRoutine main, setupcallback callback) {
		...
		comp = RegisterComponent (&desc, NewComponentRoutineProc (main), false, nil, nil, nil);
