...
extern int yyparse (void); /*langparser.c*/


extern void parsesetscanstring (Handle, boolean); /*langscan.c*/

extern unsigned long parsegetscanoffset (unsigned long, unsigned short);
