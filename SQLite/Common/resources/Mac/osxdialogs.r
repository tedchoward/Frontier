...
data 'DLOG' (518, purgeable) {
	$"00DE 0014 0159 01D7 0004 0000 0100 0000"            /* .ﬁ...Y.◊........ */
	$"0000 0206 1546 696E 6420 2620 5265 706C"            /* .....Find & Repl */
	$"6163 6520 4469 616C 6F67 0000"                      /* ace Dialog.. */
};

data 'DLOG' (1024, purgeable) {
	$"0136 0191 01C1 02CD 0001 0000 0000 0000"            /* .6.ë.¡.Õ........ */
	$"0000 0400 00"                                       /* ..... */
};

data 'DLOG' (1025, purgeable) {
	$"0136 0191 01B9 028D 0000 0000 0000 0000"            /* .6.ë.π.ç........ */
	$"0000 0401 00"                                       /* ..... */
};

data 'DLOG' (1026, purgeable) {
	$"0136 0191 0230 02EF 0000 0000 0000 0000"            /* .6.ë.0.Ô........ */
	$"0000 0402 00"                                       /* ..... */
};

data 'DLOG' (1027, purgeable) {
	$"00A8 00AC 00FB 019D 0003 0100 0100 0000"            /* .®.¨.˚.ù........ */
	$"0000 0403 00"                                       /* ..... */
};

data 'DITL' (518, purgeable) {
	$"000B 0000 0000 005B 0154 006F 01B1 0404"            /* .......[.T.o.±.. */
	$"4669 6E64 0000 0000 009E 000B 00B2 0051"            /* Find.....û...≤.Q */
	...
	$"5265 706C 6163 6574 0000 0000 000D 000A"            /* Replacet.......¬ */
	$"001D 003A 8805 4669 6E64 3A07 0000 0000"            /* ...:à.Find:..... */
	$"000D 004E 001D 013D 1004 4669 6E64 0000"            /* ...N...=..Find.. */
	$"0000 0029 000A 0039 0046 8808 5265 706C"            /* ...).¬.9.Fà.Repl */
	$"6163 653A 0000 0000 0029 004E 0039 013D"            /* ace:.....).N.9.= */
	$"1007 5265 706C 6163 6500 0000 0000 0048"            /* ..Replace......H */
	$"0009 005A 0073 050B 5768 6F6C 6520 776F"            /* .∆.Z.s..Whole wo */
	$"7264 7300 0000 0000 0048 0074 005A 00D9"            /* rds......H.t.Z.Ÿ */
	$"050B 4967 6E6F 7265 2063 6173 6500 0000"            /* ..Ignore case... */
	$"0000 0048 00D9 005A 0140 050B 5772 6170"            /* ...H.Ÿ.Z.@..Wrap */
	$"2061 726F 756E 6400 0000 0000 005C 0009"            /*  around......\.∆ */
	$"006E 00D9 0517 5573 6520 5265 6775 6C61"            /* .n.Ÿ..Use Regula */
