...
resource 'STR#' (513, "recording", purgeable) {
	{	/* array StringArray: 10 elements */
		...
		"\tappleEvent (^0, '^1', '^2'",
		/* [13] */
		"«no verb table found for “^0”",
		/* [14] */
		"There are ^0 clients connected to Frontier’s UserTalk component.  Quit anyway?",
		/* [15] */
		"The application “^0” is connected to Frontier’s UserTalk component.  Quit anyway?"
	}
};
