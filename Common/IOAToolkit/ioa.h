...
typedef struct tyioaconfigrecord {
	...
	} tyioaconfigrecord, *ptrioaconfigrecord, **hdlioaconfigrecord;
	
	
void setupconfig (tyioaconfigrecord *); /*every IOA component must define this routine*/
