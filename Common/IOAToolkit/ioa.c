...
void IOAellipsize (Str255 bs, short width) {
	...
	*/
	...
	len = (long) bs [0]; /* current length in characters*/
...
static	pascal ComponentResult IOAmain (ComponentParameters *params, Handle hstorage) {
	...
	switch ((*params).what) {
		...
		case kComponentCloseSelect:
			...
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP IOAcloseUPP  = NewComponentFunctionUPP((ProcPtr) &IOAclose, IOAcloseProcInfo);
		...
		case kComponentCanDoSelect:
			...
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP IOAcandoUPP  = NewComponentFunctionUPP((ProcPtr) &IOAcando, IOAcandoProcInfo);
		...
		case kComponentVersionSelect:
			...
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP IOAversionUPP  = NewComponentFunctionUPP((ProcPtr) &IOAversion, IOAversionProcInfo);
		...
		case IOAgetconfigcommand:
			...
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP getconfigcommandUPP  = NewComponentFunctionUPP((ProcPtr) &getconfigcommand, getconfigcommandProcInfo);
		...
		case IOAinitobjectcommand:
			...
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP initobjectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &initobjectcommand, initobjectcommandProcInfo);
		...
		case IOAdrawobjectcommand:
			...
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP drawobjectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &drawobjectcommand, drawobjectcommandProcInfo);
		...
		case IOAeditobjectcommand:
			...
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP editobjectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &editobjectcommand, editobjectcommandProcInfo);
		...
		case IOAkeystrokecommand:
			...
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP keystrokecommandUPP  = NewComponentFunctionUPP((ProcPtr) &keystrokecommand, keystrokecommandProcInfo);
		...
		case IOAidlecommand:
			...
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP idleobjectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &idleobjectcommand, idleobjectcommandProcInfo);
		...
		case IOAclickcommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP clickobjectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &clickobjectcommand, clickobjectcommandProcInfo);
		...
		case IOAcleanupcommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP cleanupobjectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &cleanupobjectcommand, cleanupobjectcommandProcInfo);
		...
		case IOArecalccommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP recalcobjectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &recalcobjectcommand, recalcobjectcommandProcInfo);
		...
		case IOAcanreplicatcommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP canreplicateobjectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &canreplicateobjectcommand, canreplicateobjectcommandProcInfo);
		...
		case IOAcatchreturncommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP catchreturncommandUPP  = NewComponentFunctionUPP((ProcPtr) &catchreturncommand, catchreturncommandProcInfo);
		...
		case IOAgetobjectinvalrectcommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP getinvalrectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &getinvalrectcommand, getinvalrectcommandProcInfo);
		...
		case IOAgetobjecteditrectcommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP geteditrectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &geteditrectcommand, geteditrectcommandProcInfo);
		...
		case IOAgetvaluecommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP getvaluecommandUPP  = NewComponentFunctionUPP((ProcPtr) &getvaluecommand, getvaluecommandProcInfo);
		...
		case IOAsetvaluecommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP setvaluecommandUPP  = NewComponentFunctionUPP((ProcPtr) &setvaluecommand, setvaluecommandProcInfo);
		...
		case IOAsetcursorcommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP setcursorcommandUPP  = NewComponentFunctionUPP((ProcPtr) &setcursorcommand, setcursorcommandProcInfo);
		...
		case IOAunpackdatacommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP unpackdatacommandUPP  = NewComponentFunctionUPP((ProcPtr) &unpackdatacommand, unpackdatacommandProcInfo);
		...
		case IOAdebugobjectcommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP debugobjectcommandUPP  = NewComponentFunctionUPP((ProcPtr) &debugobjectcommand, debugobjectcommandProcInfo);
		...
		case IOAgetattributescommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP getattributescommandUPP  = NewComponentFunctionUPP((ProcPtr) &getattributescommand, getattributescommandProcInfo);
		...
		case IOAsetattributescommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP setattributescommandUPP  = NewComponentFunctionUPP((ProcPtr) &setattributescommand, setattributescommandProcInfo);
		...
		case IOAgeticoncommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP geticoncommandUPP  = NewComponentFunctionUPP((ProcPtr) &geticoncommand, geticoncommandProcInfo);
		...
		case IOAgetcardcommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP getcardcommandUPP  = NewComponentFunctionUPP((ProcPtr) &getcardcommand, getcardcommandProcInfo);
		...
		case IOApackdatacommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP packdatacommandUPP  = NewComponentFunctionUPP((ProcPtr) &packdatacommand, packdatacommandProcInfo);
		...
		case IOAdisposedatacommand:
			#if TARGET_API_MAC_CARBON
			{
			ComponentFunctionUPP disposedatacommandUPP  = NewComponentFunctionUPP((ProcPtr) &disposedatacommand, disposedatacommandProcInfo);
