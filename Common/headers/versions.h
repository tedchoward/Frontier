...
#define	APP_REVISION_LEVEL			2      /* for non-final releases only */
#define	APP_BUILD_NUMBER			2      /* increment by one for every release, final or not */

#define	APP_VERSION_STRING			"10.2d2"
