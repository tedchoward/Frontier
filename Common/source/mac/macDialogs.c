...
boolean alertdialog (bigstring bsprompt) {
	...
	*/
	...
	CFStringRef dialogPrompt = CFStringCreateWithPascalString(kCFAllocatorDefault, bsprompt, kCFStringEncodingMacRoman);
	
	CreateStandardAlert(kAlertCautionAlert, CFSTR("Alert"), dialogPrompt, NULL, &theAlert);
